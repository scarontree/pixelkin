...
#ifndef DESKTOPPET_SWIFT_H
#define DESKTOPPET_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DesktopPet",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC10DesktopPet11AppDelegate")
...
SWIFT_CLASS("_TtC10DesktopPet8PetPanel")
...
@class NSCoder;
/// Sprite 渲染视图 — 使用 AppKit 自绘，避免 CALayer.contents 带来的透明合成抖动
SWIFT_CLASS("_TtC10DesktopPet16SpriteRenderView")
@interface SpriteRenderView : NSView
